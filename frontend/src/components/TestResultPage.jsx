...
const TestResultPage = () => {
  ...
  const proctorData = violations || {
    NO_FACE: 0, MULTIPLE_FACE: 0, AUDIO_DETECTED: 0, TAB_SWITCH: 0, BOOK_DETECTED: 0, PHONE_DETECTED: 0,
  };
      ...
      <div className="trp-body">
        ...
        <div className="trp-proctor-card">
          ...
          <div className="trp-proctor-grid">
            ...
            <ProcRow icon="bi-mic-fill" label="Voice Detected" count={proctorData.AUDIO_DETECTED || 0} color="#8b5cf6" />
